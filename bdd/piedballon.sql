...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 25 oct. 2023 à 09:23
...
INSERT INTO `equipes` (`nom_equipe`, `id_equipe`, `nb_match_joues`, `nb_match_gagnes`, `nb_match_egalites`, `prenom_entraineur`, `entraineur_nom`, `entraineur_prenom`, `entraineur_adjoint_nom`, `entraineur_adjoint_prenom`, `id_club`) VALUES
('Le Paris St Germain', 1, 9, 2, 4, '', 'Elsner', 'Luka', 'Costa', 'Serge', 1),
...
(2, '2023-10-17 20:00:00', 'Argeles mer', 2, 1, 1),
(3, '2023-09-29 00:00:00', 'Lescar', 5, 2, 1),
(4, '2023-10-18 00:00:00', 'Pau', 0, 0, 0),
(6, '2023-10-04 00:00:00', 'Botilo', 1, 3, 0),
(8, '2023-05-12 00:00:00', 'Bureau', 5, 0, 1),
(10, '2023-10-10 00:00:00', 'Fauteuil Basque', 3, 1, 0),
(11, '2023-10-17 00:00:00', 'Palao', 0, 8, 1);
...
CREATE TABLE `remplace` (
  `id_joueur` int(11) NOT NULL,
  `est_remplace` tinyint(1) NOT NULL,
...
INSERT INTO `remplace` (`id_joueur`, `est_remplace`, `id_remplacement`) VALUES
(9, 1, 3),
(10, 1, 5),
(11, 1, 4),
(12, 0, 3),
...
INSERT INTO `utilisateurs` (`id_utilisateur`, `nom`, `prenom`, `adresse_mail`, `mot_de_passe`, `est_admin`) VALUES
(1, 'Laclef', 'David', 'david.laclef@mail.fr', '$2y$10$wGgnazxYLAfgmqEH6twnD.pCFMbFHEaKTolkHqNSUOlvfMPdzezNu', 0);
...
--
ALTER TABLE `remplacements`
  MODIFY `id_remplacement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
