...
$joueur_adversaire = $getmatch->fetchAll(PDO::FETCH_OBJ);
...
$equipe_adversaire = $getmatch->fetchAll(PDO::FETCH_OBJ);
...
<body>
    <section class="parametre all_Participant">
        ...
        <div class="principal equipe_1">
            ...
            <div class="card_container">
                <p class="card_number Division_number">1</p>
                <p id="first_team_mode_view" class="card_info Division_name"><?php echo $equipe[0]->nom_equipe  ?></p>
        ...
        <div class="principal equipe_2">
            ...
            <div class="card_container">
                ...
                <p id="second_team_mode_view" class="card_info Division_name"><?php echo $equipe_adversaire[0]->nom_equipe  ?></p>                <input id="second_team_mode_edit" type="text">
            ...
            <div class="popup_info">
                ...
                <div class="card_container">
                        ...
                        <div class="text_info_joueur">
                            <p class="card_info card_info_joueur_nom "><?= $nom." ".$prenom ?></p>
                        </div>
                    </div>              
            <?php endforeach ?>
        ...
        <div id="second_popup">
            ...
            <div class="popup_info">
                <div class="principal info_joueur">
                    <h2>Infos des joueurs</h2>
                    <?php
                foreach($joueur_adversaire as $Value) : ;
                    $nom = $Value->nom;
                    $prenom = $Value->prenom;
                    $number = $Value->numero;
                    ?>
