...
<body>
    ...
    <section class="parametre all_Participant">
        <div class="principal arbitre">
            <h2>Choisir le joueur qui va rentrer</h2>
            <?php
                foreach($arbitre as $Value) : ;
                    ...
                    <div class="card_container">
                        ...
                        <a href=<?php echo "../php/match_remplacement_deux.php?id_equipe=".$id_equipe."&temps_jeux=".$temps_jeux."&id_joueur=".$id_arbitre ?>><button class="button_svg_edit" style="font-size: 1.5em;">+</button></a>
                    </div>                
            <?php endforeach ?>
        </div>
